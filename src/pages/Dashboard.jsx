...
const Dashboard = () => {
  ...
  fetchData();
    ...
    useEffect(() => {
        ...
        // ========== PIE CHART (Occupied vs Available PCs) ==========
        ...
        // ========== LINE CHART (Students trend, mock data) ==========
        ...
        // ========== HORIZONTAL BAR CHART (Labs vs PCs) ==========
    ...
    return (
        <div className="flex">
            {/* Sidebar */}
            <aside className="w-64 bg-gray-800 text-gray-200 min-h-screen p-6">
                <h2 className="text-2xl font-bold text-blue-400 mb-8">Admin Panel</h2>
                <ul className="space-y-4 flex flex-col">
                    <Link to={"/"} className="hover:text-white cursor-pointer">Dashboard</Link>
                    <Link to={"/lab"} className="hover:text-white cursor-pointer">Labs</Link>
                    <Link to={"/systems"} className="hover:text-white cursor-pointer">Systems</Link>
