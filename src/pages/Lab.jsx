...
const Lab = () => {
  ...
  const filteredLabs = labfetchedData.filter((lab) =>
    [lab.name, lab.location, lab.capacity?.toString()]
      .join(" ")
      .toLowerCase()
                ...
                filteredLabs.map((lab) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-4 flex gap-3">
                      <Link to={`/edit-lab/${lab.id}`} className="text-blue-500">
                        Edit
                      </Link>
                      <button
